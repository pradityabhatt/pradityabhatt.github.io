...
//          icon:"images/librarypushpin.png",
            ...
            //
                    ...
                    for (var i = 0; i < c.length; i++) {
                        ...
                        libraryPins[i].metadata = {
                            ...
                            description: c[i].properties.LATITUDE + "/" + c[i].properties.LONGITUDE + "," + c[i].properties.RANKING + ";" + c[i].properties.BUILDING_SQ_FT
        ...
        function pinsClicked(e) {
            if (e.target.metadata) {
                ...
                var desc = e.target.metadata.description;
                var area = desc.substring(desc.indexOf(';') + 1, );
                var rank = desc.substring(desc.indexOf(',') + 1, desc.indexOf(';'));
            ...
            /**
             * this function shows the direction to selected library
             * @returns {undefined}
             */
            function getLibraryDirection(latitude, longitude) {
                navigator.geolocation.getCurrentPosition(function (position) {
                    ...
                    Microsoft.Maps.loadModule('Microsoft.Maps.Directions', function () {
                        ...
                        var wp1 = new Microsoft.Maps.Directions.Waypoint({address: 'YOUR LOCATION', location: new Microsoft.Maps.Location(position.coords.latitude, position.coords.longitude)});
                        var wp2 = new Microsoft.Maps.Directions.Waypoint({address: 'LIBRARY LOCATION', location: new Microsoft.Maps.Location(latitude, longitude)});
